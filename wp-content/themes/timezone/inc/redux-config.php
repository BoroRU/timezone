...
$opt_name = 'redux';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Используйте переменную: $%1$s', 'your-textdomain-here' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
...
require_once get_template_directory() . "/inc/redux-components/home/top-section.php";
require_once get_template_directory() . "/inc/redux-components/home/gallery.php";
require_once get_template_directory() . "/inc/redux-components/home/video.php";
require_once get_template_directory() . "/inc/redux-components/home/clocks.php";
require_once get_template_directory() . "/inc/redux-components/other/advantages.php";


Redux::set_section(
    $opt_name,
    array(
        'title' => esc_html__('About page', 'your-textdomain-here'),
        'id' => 'about',
        'customizer_width' => '400px',
        'icon' => 'el el-home',
    )
);
require_once get_template_directory() . "/inc/redux-components/about/main.php";
// Подвал
require_once get_template_directory() . "/inc/redux-components/footer.php";
